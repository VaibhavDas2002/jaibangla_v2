                    ...
                    <div class="section1">
                        <div class="row">
                            ...
                            <div class="col-md-3 text-center">
                                <div class="modal_field_value">
                                    <img src="{{ url('/') }}/bower_components/Emblem_of_West_Bengal.png"
                                        alt="Emblem of West Bengal" width="180px" height="200px">
                                </div>
                            </div>

                            <!-- Middle Column with Headings -->
...
<script>
    ...
    document.getElementById('btn_submit_preview').addEventListener('click', function () {
        var app_phase = document.getElementById('app_phase');
        if (app_phase) {
        ...
        var temple_type = document.getElementById('temple_type');
        if (temple_type) {
        ...
        var land_holdername = document.getElementById('land_holdername');
        if (land_holdername) {
        ...
        function updatePensionModal() {
            const selectedPensions = [];
            const checkboxes = document.querySelectorAll('.receive-pension:checked');
            checkboxes.forEach(function (checkbox) {
                const label = checkbox.parentNode.textContent.trim();
                selectedPensions.push(label);
            });
            document.getElementById('receive-pension-modal').textContent = selectedPensions.join(', ');
        }
        updatePensionModal();
        document.querySelectorAll('.receive-pension').forEach(function (checkbox) {
            checkbox.addEventListener('change', updatePensionModal);
        });
