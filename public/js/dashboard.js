...
function loadLocalBody(element,service_category) {  
  ...
  loadItems(element,service_category, '../public/api/localbody/', '.js-localbody');
}
/*******SD*********/
function loadProgrammeHead(element,service_category) {
  ...
  loadItems(element,service_category, '../public/api/programmehead/', '.js-programme_head');
}
...
function loadDesignationList(element,service_category,major_programme_head) {
  ...
  loadItems2(element,service_category,major_programme_head, '../public/designationlist/', '.js-designation_list');
}
...
function loadPostingPlace(element) {
  ...
  loadPostingPlaceajax(element, '../public/postingplace/', '.js-posting_place');
}
/***********************************end********************************************/
...
function loadMajorProgrammeHead(element){
  ...
  $('.js-programme_head').empty().append('<option value="">Please select your Programme Head</option>');
  $('.js-designation_list').empty().append('<option value="">Please select your Designation</option>');
   loadItems1(element, '../public/api/majorprogrammehead/', '.js-major_programme_head');
...
function loadlevel2(element){
   $('.js-reportlevel2').empty().append('<option value="">Please select Field</option>');
  loadItems1(element, '../public/api/loadlevel2/', '.js-reportlevel2');
  
}
/*******sd drilldown in dashboard************/
function loadlevel2d(element,reportlevel1_data){
   $('.js-reportlevel2').empty().append('<option value="">Please select Field</option>');
  loadItems2d(element,reportlevel1_data, '../public/api/loadlevel2d/', '.js-reportlevel2');
  
}
/*******************************************/
function loadlevel3(element){
   $('.js-reportlevel2').empty().append('<option value="">Please select Field</option>'); 
    loadItems1_1(element, '../public/api/loadlevel3/', '.js-reportlevel3');
}
...
function loadlevel4(element){
  console.log("level4 called"+reportlevel2d_data);
    if(reportlevel2d_data!=0){
      loadItems2_2d(element,reportlevel1_data,reportlevel2_data,reportlevel2d_data, '../public/api/loadlevel4d/', '.js-reportlevel4');
    }else{
      loadItems2_2(element,reportlevel1_data,reportlevel2_data, '../public/api/loadlevel4/', '.js-reportlevel4');
    }
...
function loadreportafterlevel2(element,reportlevel1_data) {  
  ...
  loadreportafterlevel2ajax(element,reportlevel1_data,'../public/loadreportafterlevel2/','.js-reportapplicationssubmittedcount','.js-reportpendingverificationcount'
...
function loadreportafterlevel3(element,reportlevel1_data,reportlevel2_data) {  
  ...
  $('.js-reportrejectedcount').empty().append('0');
  $('.js-reportrejectedapprovalcount').empty().append('0');    
  loadreportafterlevel3ajax(element,reportlevel1_data,reportlevel2_data,'../public/loadreportafterlevel3/','.js-reportapplicationssubmittedcount','.js-reportpendingverificationcount'
    ,'.js-reportpendingapprovalcount','.js-employeecodegeneratedcount','.js-reportverifiedcount','.js-reportrejectedcount','.js-reportrejectedapprovalcount');
}
...
function loadreportafterlevel4(element,reportlevel1_data,reportlevel2_data,reportlevel3_data) {  
  ...
  $('.js-reportrejectedcount').empty().append('0');
  $('.js-reportrejectedapprovalcount').empty().append('0');    
  loadreportafterlevel4ajax(element,reportlevel1_data,reportlevel2_data,reportlevel3_data,'../public/loadreportafterlevel4/','.js-reportapplicationssubmittedcount','.js-reportpendingverificationcount'
    ,'.js-reportpendingapprovalcount','.js-employeecodegeneratedcount','.js-reportverifiedcount','.js-reportrejectedcount','.js-reportrejectedapprovalcount');
}
